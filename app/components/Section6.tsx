...
export default function RescuedMeals() {
  ...
  return (
    <section id="marketplace" className="relative w-full bg-[#F4F3EE] py-16 sm:py-20 lg:py-28 overflow-hidden font-[family:var(--font-jakarta)] select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        ...
        <div className="lg:hidden w-full flex flex-col items-center text-center mb-8">
          <motion.div 
            ...
            className="bg-[#2D2A26] text-white text-[9px] min-[400px]:text-[10px] font-black uppercase tracking-[0.3em] px-3.5 py-1.5 rounded-md shadow-md mb-2.5 w-max"
          >
            Live Marketplace
          </motion.div>
          <motion.h2 
            ...
            className="relative font-black uppercase tracking-tighter leading-[0.85] text-[#2D2A26] text-[30px] min-[400px]:text-[36px]"
          >
            RESCUE MEALS <br />
            <span className="bg-gradient-to-r from-[#F28F3B] to-[#FF6B35] text-white px-3 py-0.5 rounded-[10px] shadow-[0_12px_24px_rgba(242,143,59,0.25)] border-2 border-white transform rotate-1.5 inline-block text-[22px] min-[400px]:text-[26px] mt-1.5">
              NEAR YOU
            </span>
          </motion.h2>
        </div>

        <div className="hidden lg:flex flex-col items-center text-center mb-12">
          <motion.div 
            initial={{ opacity: 0, scale: 0.4, rotate: -12, y: 40 }}
            whileInView={{ opacity: 1, scale: 1, rotate: 0, y: 0 }}
            viewport={{ once: true }}
            transition={stickerSpringTransition}
            className="bg-[#2D2A26] text-white text-[10px] font-black uppercase tracking-[0.3em] px-4 py-1.5 rounded-md shadow-md mb-3 w-max"
          >
            Live Marketplace
          </motion.div>
          <motion.h2 
            ...
            className="relative font-black uppercase tracking-tighter leading-[0.8] flex flex-col items-center text-[#2D2A26] text-[54px] xl:text-[64px]"
          >
            <span>RESCUE MEALS</span>
            <span className="bg-gradient-to-r from-[#F28F3B] to-[#FF6B35] text-white px-5 py-0.5 rounded-[16px] shadow-[0_15px_30px_rgba(242,143,59,0.25)] border-4 border-white transform rotate-1.5 inline-block text-[38px] xl:text-[46px] mt-2">
              NEAR YOU
            </span>
          </motion.h2>
        </div>
        ...
        <motion.div
          ...
          className="flex gap-2 sm:gap-3 overflow-x-auto pb-5 mb-8 justify-start lg:justify-center px-2 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden"
        >
          {categories.map((cat) => (
            <motion.button
              key={cat}
              ...
              whileTap={{ scale: 0.95 }}
              className="shrink-0 snap-center px-4.5 py-2 sm:px-5 sm:py-2.5 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 border bg-white/60 backdrop-blur-md border-white/50 text-[#2D2A26]/60 data-[active=true]:bg-[#2D2A26] data-[active=true]:border-[#2D2A26] data-[active=true]:text-white data-[active=true]:shadow-xl hover:bg-white"
        ...
        {hasMore && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-md border border-white hover:bg-white text-[#2D2A26] font-bold text-[10px] sm:text-xs uppercase tracking-widest px-5 py-2.5 sm:px-7 sm:py-3.5 rounded-full transition-all duration-300 shadow-md hover:shadow-xl group"
            >
              Load More ({filtered.length - visibleCount})
              <ChevronRight size={14} className="group-hover:translate-x-1 transition-transform w-3 h-3 sm:w-4 sm:h-4" />
            </motion.button>
          </motion.div>
        )}
